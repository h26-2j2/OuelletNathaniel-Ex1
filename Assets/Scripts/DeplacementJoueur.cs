...
public class DeplacementJoueur : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float distanceAvecZone = Vector2.Distance(zoneArrivee.transform.position, transform.position);
        float distanceMinPourCollision = (transform.localScale.x / 2) + (zoneArrivee.transform.localScale.x / 2);
